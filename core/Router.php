<?php
/**
* Router class to use like MVC
* Can redirect urls with MVC good formating urls controller/action/param/param/param....
* Router::prefix('bs-admin','admin');
* Router::connect('','posts/index');
* Router::connect('bs-admin','bs-admin/posts/index');
...
class Router{
	...
	/**
	 * Url
	 * Ganarate url form original url
