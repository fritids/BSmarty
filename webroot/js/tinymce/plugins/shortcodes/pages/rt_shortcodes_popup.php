...
if($_GET['section']=='layouts'){
	echo 'LAYOUTS SELECTION';
}elseif($_GET['section']=='shortcodes'){
	echo 'SHORTCODES SELECTION';
}elseif($_GET['section']=='buttons'){
	echo 'BUTTONS SELECTION';	
}else{
	echo 'QUICK STYLING SELECTION';
}
?>
</title>
...
<div id="values">
	...
	<div id="two-cols">
		<br class="clear" />
		<div class="boxes row">
			<div class="box span8 first"><?php echo $dummy_text;?></div>
			<div class="box span8 last"><?php echo $dummy_text;?></div>
		</div>
		<br class="clear" />
	</div>	
	...
	<div id="three-cols">
		<br class="clear" />
		<div class="boxes row">
			<div class="box span-one-third first"><?php echo $dummy_text;?></div>
			<div class="box span-one-third"><?php echo $dummy_text;?></div>
			<div class="box span-one-third last"><?php echo $dummy_text;?></div>
		</div>
		<br class="clear" />
	</div>
	...
	<div id="four-cols">
		<br class="clear" />
		<div class="boxes row">
			<div class="box span4 first"><?php echo $dummy_text;?></div>
			<div class="box span4"><?php echo $dummy_text;?></div>
			<div class="box span4"><?php echo $dummy_text;?></div>
			<div class="box span4 last"><?php echo $dummy_text;?></div>
		</div>
		<br class="clear" />
	</div>
	...
	<div id="five-cols">
		<br class="clear" />
		<div class="boxes row">
			<div class="box span3 first"><?php echo $dummy_text;?></div>
			<div class="box span3"><?php echo $dummy_text;?></div>
			<div class="box span3"><?php echo $dummy_text;?></div>
			<div class="box span3"><?php echo $dummy_text;?></div>
			<div class="box span3 last"><?php echo $dummy_text;?></div>
		</div>
		<br class="clear" />
	</div>
	...
	<div id="two-three-cols">
		<br class="clear" />
		<div class="boxes row">
			<div class="box span-two-thirds first"><?php echo $dummy_text;?></div>
			<div class="box span-one-third last"><?php echo $dummy_text;?></div>
		</div>
		<br class="clear" />
	</div>
	...
	<div id="three-four-cols">
		<br class="clear" />
		<div class="boxes row">
			<div class="box span12 first"><?php echo $dummy_text;?></div>
			<div class="box span4 last"><?php echo $dummy_text;?></div>
		</div>
		<br class="clear" />
	</div>
	...
	<div id="four-five-cols">
		<br class="clear" />
		<div class="boxes row">
			<div class="box span14 first"><?php echo $dummy_text;?></div>
			<div class="box span2 last"><?php echo $dummy_text;?></div>
		</div>
		<br class="clear" />
	</div>
