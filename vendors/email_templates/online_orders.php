	...
	<tr>
		...
		<td class="header container" >
				...
				<table bgcolor="#FFFFFF">
					<tr>
						<td><img src="{{site_url}}/images/logo.jpg" alt="logo_alternative" /></td>
						<td align="right"><h6 class="collapse">Your name and slogan</h6></td>
					</tr>
				</table>
				</div>
			...
			<table>
				<tr>
					<td>
						...
						<p class="lead">The is a new order from {{firstname}} {{lastname}}, on {{date}}.</p>
						<h4>Order details</h4>
						<p>Place of delivery : {{shipping}}.</p>
						<p>The order is composed of <strong>{{nb_items}} item(s)</strong>:</p>
						{{table}}
						<hr />

						<h4>Notice</h4>
						<p>To manage all online orders, please go to:</p>
						<!-- Callout Panel -->
						<p class="callout">
							<a href="{{site_url}}/bs-admin">{{site_url}}/bs-admin &raquo;</a>
						</p><!-- /Callout Panel -->
