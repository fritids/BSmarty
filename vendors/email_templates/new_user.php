		...
		<td class="container" bgcolor="#FFFFFF">
			...
			<table>
				<tr>
					<td>
						<h3>New user</h3>
						<p class="lead">There is a new registred user : {{firstname}} {{lastname}}, on {{date}}.</p>
						<h4>Notice</h4>
						<p>To manage users (delete/revoke/accept) and have access to the personnal informations on the website, please go to:</p>
						<!-- Callout Panel -->
						<p class="callout">
