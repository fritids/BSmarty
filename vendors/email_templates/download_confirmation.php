	...
	<tr>
		...
		<td class="container" bgcolor="#FFFFFF">
			...
			<table>
				<tr>
					<td>
						<h3>Downlaod confirmation</h3>
						<p class="lead">{{firstname}} {{lastname}} has donwloaded the file {{filename}}, on {{date}}.</p>
						<h4>Notice</h4>
						<p>To manage the files availbles for download on the website, please go to:</p>
						<!-- Callout Panel -->
						<p class="callout">
